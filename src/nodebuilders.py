...
def extract_title(markdown):
    ...
    raise Exception("Missing Title in document")
...
def split_and_build_new_nodes(old_node, delimiter, text_type):
    split_nodes = []
...
def split_nodes_delimiter(old_nodes, delimiter, text_type):
    ...
    for old_node in old_nodes:
        ...
        split_nodes = split_and_build_new_nodes(old_node, delimiter, text_type)
